      ...
      >
        {bool ? (
          <>
            ...
            <p>
              <strong>IMDb :</strong> {element.imdbRating}
            </p>
            <p>
              <strong>Release Date :</strong> {element.Released}
            </p>
            <p>
              <strong>Runtime :</strong> {element.Runtime}
            </p>
            <p>
            ...
            <p>
              <strong>Metascore :</strong> {element.Metascore}
            </p>
          </>
        ) : (
          <>
